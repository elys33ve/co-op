...
#################################
ssh_server = SSH(host=board_ip1, username='user', password='pass')
ssh_client = SSH(host=board_ip2, username='user', password='pass')
ssh_powerswitch = SSH(host=power_ip, username='user', password='pass')
